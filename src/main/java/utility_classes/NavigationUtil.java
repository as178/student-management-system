 ...
 *
 * This utility class keeps track of the currently opened frame within
 * the program. It is the core component in ensuring the user is
 * able to initialise the program, go back and forth between
 * dashboards/frames, and exit the program gracefully.
 *
 */
