 ...
 *
 */
public class StudentViewCoursesView extends JFrame {

    private Student currentStudent;

    public StudentViewCoursesView(Student student) {
        ...
        setTitle("Student Management System: View Course Details");
        ...
        JLabel headerLabel2 = new JLabel("your current courses, or see further options below.", SwingConstants.CENTER);
        ...
        //Grabbing the student's currently enrolled courses
        ...
        JButton viewPreviousButton = new JButton("View Previously Taken Courses");
        JButton backButton = new JButton("Back");
        JButton exitButton = new JButton("Exit");

        //Action commands for controller
        viewPreviousButton.setActionCommand("1");
